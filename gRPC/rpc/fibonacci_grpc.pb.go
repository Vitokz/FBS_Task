...
type FibonacciClient interface {
	CalculateFibonacci(ctx context.Context, in *FibRequest, opts ...grpc.CallOption) (*FibResponse, error)
}
...
func (c *fibonacciClient) CalculateFibonacci(ctx context.Context, in *FibRequest, opts ...grpc.CallOption) (*FibResponse, error) {
	out := new(FibResponse)
	err := c.cc.Invoke(ctx, "/rpc.Fibonacci/CalculateFibonacci", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	CalculateFibonacci(context.Context, *FibRequest) (*FibResponse, error)
...
func (UnimplementedFibonacciServer) CalculateFibonacci(context.Context, *FibRequest) (*FibResponse, error) {
...
func _Fibonacci_CalculateFibonacci_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Fibonacci/CalculateFibonacci",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).CalculateFibonacci(ctx, req.(*FibRequest))
	}
